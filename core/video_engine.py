...
class VideoEngine(QThread):
    ...
    def run(self):
        # ... (INICIO IGUAL QUE ANTES: Rutas, VideoCapture, etc) ...
        # --- FIX DE RUTAS ---
        ...
        # ... (CONFIGURACION DE WRITER IGUAL QUE ANTES) ...
        # (Resumido para ahorrar espacio, mantén tu lógica de writer/json init aquí)
        ...
        self.json_data = {
            "metadata": {"source": self.video_path, "width": width, "height": height, "fps": fps, "total_frames": total_frames},
            "frames": []
        }
        ...
        while self.running and cap.isOpened():
            ...
            for d in all_dets:
                ...
                det_entry = {
                    ...
                    "track_id": d.get('track_id'), # <--- NUEVO: ID Único (puede ser None)
                    "rect": { 
        ...
        try:
            ...
            self.processing_finished.emit({
                "output_dir": out_dir, "video_file": save_path_video, "json_file": save_path_json
            })
