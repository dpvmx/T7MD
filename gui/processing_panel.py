...
# Perfil
        ...
        # NUEVOS NOMBRES
        self.cmb_profile.addItems(["Final Render", "Compositing Ready", "JSON Only"]) 
        self.cmb_profile.setFixedWidth(140) # Un poco más ancho
    ...
    def setEnabled(self, enabled):
        ...
        if not enabled:
            ...
            self.lbl_status.setText("Carga un video para renderizar")
